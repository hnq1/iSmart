...
import AddRowDataExportOrderInternalManual from "./AddRowDataExportInternal";
import RowDataExportOrder from "./RowDataExportInternal";
...
const ModelAddExportOrderInternalManual = ({ isShow, handleClose, updateTable }) => {
    ...
    return (<>
        ...
        <AddRowDataExportOrderInternalManual isShow={isShowRowDataExport} selectedStorageId={selectedWarehouseId}
