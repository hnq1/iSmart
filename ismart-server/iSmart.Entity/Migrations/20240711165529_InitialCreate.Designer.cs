...
namespace iSmart.Entity.Migrations
{
    ...
    [Migration("20240711165529_InitialCreate")]
            ...
            modelBuilder.Entity("iSmart.Entity.Models.ReturnsOrder", b =>
                {
                    ...
                    b.Property<int?>("ExportOrderExportId")
                        .HasColumnType("int");

                    b.Property<int?>("ImportOrderImportId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ExportOrderExportId");

                    b.HasIndex("ImportOrderImportId");
            ...
            modelBuilder.Entity("iSmart.Entity.Models.ReturnsOrder", b =>
                {
                    ...
                    b.HasOne("iSmart.Entity.Models.ExportOrder", null)
                        .WithMany("ReturnsOrders")
                        .HasForeignKey("ExportOrderExportId");

                    b.HasOne("iSmart.Entity.Models.ImportOrder", null)
                        .WithMany("ReturnsOrders")
                        .HasForeignKey("ImportOrderImportId");
